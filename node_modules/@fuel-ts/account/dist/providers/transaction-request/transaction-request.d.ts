...
import type { TransactionScript, Policy, TransactionCreate, TransactionBlob, TransactionUpload, TransactionUpgrade } from '@fuel-ts/transactions';
import { TransactionType } from '@fuel-ts/transactions';
import type { BytesLike } from '@fuel-ts/utils';
import type { Account } from '../../account';
import type { Coin } from '../coin';
import type { CoinQuantity, CoinQuantityLike } from '../coin-quantity';
import { type Message, type MessageCoin } from '../message';
...
export declare abstract class BaseTransactionRequest implements BaseTransactionRequestLike {
    ...
    abstract toTransaction(): TransactionCreate | TransactionScript | TransactionBlob | TransactionUpgrade | TransactionUpload;
    /**
     ...
     */
    updateWitnessByOwner(address: AddressInput, signature: BytesLike): void;
    /**
     ...
     */
    addMessageInput(message: Message | MessageCoin): void;
    /**
     ...
     */
    fundWithFakeUtxos(quantities: CoinQuantity[], baseAssetId: string, resourcesOwner?: Address): this;
    /**
