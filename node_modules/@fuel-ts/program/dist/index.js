...
var BaseInvocationScope = class {
    ...
    calls.forEach((c) => {
      ...
      if (c.externalContractsAbis) {
        Object.keys(c.externalContractsAbis).forEach(
          (contractId) => this.transactionRequest.addContractInputAndOutput(new import_address.Address(contractId))
        );
      }
    });
  }
  ...
  async fundWithRequiredCoins() {
    ...
    missingContractIds.forEach((contractId) => {
      transactionRequest.addContractInputAndOutput(new import_address.Address(contractId));
    });
  ...
  addTransfer(transferParams) {
    ...
    this.transactionRequest = this.transactionRequest.addCoinOutput(
      new import_address.Address(destination),
      amount,
      assetId
    );
    return this;
...
var Contract = class {
  ...
  constructor(id, abi, accountOrProvider) {
    ...
    this.id = new import_address2.Address(id);
